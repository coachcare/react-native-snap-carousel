...
export default class Pagination extends PureComponent {
    ...
    static propTypes = {
        ...
        containerStyle:  (ViewPropTypes ? ViewPropTypes?.style : View?.propTypes?.style) ?? PropTypes.any,
        dotColor: PropTypes.string,
        dotContainerStyle:  (ViewPropTypes ? ViewPropTypes?.style : View?.propTypes?.style) ?? PropTypes.any,
        dotElement: PropTypes.element,
        dotStyle:  (ViewPropTypes ? ViewPropTypes?.style : View?.propTypes?.style) ?? PropTypes.any,
        inactiveDotColor: PropTypes.string,
        inactiveDotElement: PropTypes.element,
        inactiveDotOpacity: PropTypes.number,
        inactiveDotScale: PropTypes.number,
        inactiveDotStyle:  (ViewPropTypes ? ViewPropTypes?.style : View?.propTypes?.style) ?? PropTypes.any,
